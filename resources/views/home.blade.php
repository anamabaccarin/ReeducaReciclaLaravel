...
@section('content')
	...
	<main class="container-fluid ">
		...
		<div class="col-md-6 texto-info-home px-3">
            <article>
                <h1 class="titulo-card-home d-none d-sm-none d-md-block d-lg-block d-xl-block ">
                    Por que <span class="color-title">reciclar ?</span>
                </h1>
                <h2 class="titulo-card-home d-block d-sm-block d-md-none d-lg-none d-xl-none">
                    Por que <span class="color-title">reciclar ?</span>
                </h2>
	...
	<main class="container-fluid no-gutters main-pag-home">
		...
		<div class="row no-gutters recicla-texto">
			...
			<div class="col-md-6 texto-info-home px-3 d-none d-sm-none d-md-block d-lg-block d-xl-block">
				<article>
					<h1 class="titulo-card-home-loja d-none d-sm-none d-md-block d-lg-block d-xl-block ">
                        Visite nossa loja <span class="color-title">virtual!</span>
					</h1>					
	...
	<main class="container-fluid ">
        ...
        <div class="col-md-6 texto-info-home px-3">
            <article>
                <h1 class="titulo-card-home d-none d-sm-none d-md-block d-lg-block d-xl-block ">
                    Nossos <span class="color-title">Parceiros!</span>
                </h1>
                <h2 class="titulo-card-home d-block d-sm-block d-md-none d-lg-none d-xl-none">
                    Nossos <span class="color-title">Parceiros !</span>
                </h2>
